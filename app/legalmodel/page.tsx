      ...
      <main className="flex-grow">
        <section className="relative text-center py-24 sm:py-32 overflow-hidden">
           <div aria-hidden="true" className="absolute inset-0 z-0">
              <div className="absolute top-0 left-0 h-full w-full bg-[radial-gradient(#A6A6A6_1px,transparent_1px)] [background-size:16px_16px] hidden dark:block"></div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto px-4">
              ...
              <p className="mt-6 text-lg sm:text-xl text-legal-bg/70 dark:text-legal-text-secondary max-w-2xl mx-auto">
