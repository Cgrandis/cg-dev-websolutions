...
export default function Hero() {
  ...
  return (
    <section className="text-center my-24 sm:my-32 mx-4 sm:mx-8 md:mx-16 lg:mx-24">
      ...
      <p className="max-w-3xl mx-auto text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-12 font-light">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
          {features.map((feature, index) => (
            <div key={index} className="flex items-center justify-center sm:justify-start gap-4">
              ...
              <p className="text-md sm:text-lg text-gray-700 dark:text-gray-200 text-left">
                {feature.text}
              </p>
            </div>
          ))}
